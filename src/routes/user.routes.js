...
const formatUserForResponse = (user) => {
    ...
    camelCaseUser._id = camelCaseUser.id;
    delete camelCaseUser.id;
    delete camelCaseUser.passwordHash; // Don't return password hash
...
// Get user profile (legacy) - redirects to /me
router.get('/profile', authenticate, async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            user: formattedUser,
            deprecated: 'This endpoint is deprecated, please use GET /users/me instead'
        });
    } catch (error) {
        console.error('Error fetching user profile:', error);
        res.status(500).json({
...
// Update user profile (legacy) - redirects to PUT /:id
router.put('/profile', authenticate, [
    ...
    try {
        ...
        res.status(200).json({
            ...
            user: formattedUser,
            deprecated: 'This endpoint is deprecated, please use PUT /users/:id instead'
        });
    } catch (error) {
...
// Change password (legacy) - redirects to PUT /:id/password
router.put('/change-password', authenticate, [
    ...
    try {
        ...
        res.status(200).json({
            success: true,
            message: 'Password changed successfully',
            deprecated: 'This endpoint is deprecated, please use PUT /users/:id/password instead'
        });
    } catch (error) {
        console.error('Error changing password:', error);
        res.status(500).json({
