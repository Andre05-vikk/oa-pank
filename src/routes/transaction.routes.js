...
const {verifyTransaction, getBankPublicKey, CENTRAL_BANK_URL} = require('../config/central-banks.config');
const {sendTransactionToBank, verifyIncomingTransaction} = require('../config/interbank.config');
const {getAll, getById, createTransaction, processIncomingTransaction, getBy, db} = require('../config/database');
const {convertCurrency, getCurrencyRates} = require('../config/currency.config');
            ...
            if (isInternal) {
                ...
                try {
                    ...
                    try {
                        ...
                        const result = await sendTransactionToBank(externalTransactionData, targetBank.api_url);
...
router.post('/incoming', async (req, res) => {
    try {
        const {fromAccount, toAccount, amount, currency, description, reference} = req.body;
